...
Dietary = ["Halal", "Kosher", "Hindu", "Vegan", "Vegetarian",
           "Lactose intolerant", "Gluten free", "Peanut allergy",
           "Tree Nut allergy", "Seafood allergy", "Egg allergy", "Soy allergy", "Wheat allergy"]
...
for i in range(0, 1000):
    ...
    diet = [False for i in range(14)]
    num_diet = random.randint(0, 6)
